...
import static b.claudia.simpletodo.MainActivity.ITEM_POSITION;
import static b.claudia.simpletodo.MainActivity.ITEM_TEXT;
...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //update the title var of the activity
    ...
    public void onSaveItem(View v) {
        ...
        //set intent as the result of the acticity
        setResult(RESULT_OK, i);
        //close the activity and redirec to main
        finish();
    }
}
